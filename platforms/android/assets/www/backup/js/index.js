...
var app = {
  ...
  bindEvents: function() {
    ...
    document.getElementById('connect-button').addEventListener('click', this.connectToRainbowServer);
    document.getElementById('discover-button').addEventListener('click', this.discoverServers);
  },
  ...
  connectToRainbowServer: function(ip) {
